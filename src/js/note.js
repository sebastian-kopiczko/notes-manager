export const NoteCtrl = (function(){
  ...
  const data = {
    notes: [
      {id: 1, title: 'Test note 1 title', body: 'Test note 1 body', priority: 'low', date: '2018-08-20'},
      {id: 2, title: 'Test note 2 title', body: 'Test note 2 body', priority: 'high', date: '2018-08-22'}
    ],
    currentNote: null
  }
